	...
	<head>
		...
		<script type="text/javascript">
			...
			/*  XBack.listen(function(){
				  window.location = "${base}/mine/circle!diaryList.action?circle.id="+$("#circleId").val()+"&lastIdSign="+$("#diaryId").val();
				}); */
		</script>
	</head>
		...
		<div class="content" style="margin-top:10px;">
			...
			<c:if test="${total>20 }">
				<div class="show-more-comment" 
					onclick="window.location='${base}/mine/diary!moreComments.action?circle.id=${circle.id }&diary.id=${diary.id }'">
					点击查看更过评论
				</div>
			</c:if>
			</div>
