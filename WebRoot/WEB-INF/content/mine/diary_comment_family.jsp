	...
	<head>
		...
		<script type="text/javascript" >
			 	XBack.listen(function(){
			 		if($("#circleId").val()!=""){
			 			 window.location = "${base}/mine/circle!diaryDetail.action?circle.id="
		 					 +$("#circleId").val()
							  +"&diary.id="
							  +$("#diaryId").val();
			 		}else{
	...
	<body style="background-color:#F0EFEE;">
		...
		<script type="text/javascript">
				...
				function Refresh() {
					...
					window.location = '${base}/home/diary!showFamilyComments.action?&diaryComment.id='+diaryCommentId+'&model='+model;
				}
