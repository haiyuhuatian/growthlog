...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript"  src="${base }/phone-js/xback.js"></script>
  		<script type="text/javascript">
	  		...
	  		XBack.listen(function(){
		 		window.location = "${base}/mine/follow!list.action?lastIdSign="+$("#lastIdSign").val();
			});
	  	</script>
	</head>
	<body style="background-color:#F0EFEE;">
		<div style="width:100%;margin-top:50px;">
			...
			<input type="hidden" id="lastIdSign" value="${followId }"/>
			<div style="background-color:#fff;border:1px solid #d0cfca;width:95%;margin:0 auto;font-size:10px;">
				<ul class="detailUl">
					...
					<li onclick="window.location='${base}/mine/follow!personDiaryList.action?follow.id=${followId }&user.id=${user.id }'">
