		...
		<script type="text/javascript" >
			 	XBack.listen(function(){
			 		...
			 		if(circleId != ""&&circleId != null){
			 			window.location = "${base}/mine/diary!moreComments.action?lastCommentIdSign="
							  +$("#fatherId").val()
	...
	<body style="background-color:#F0EFEE;">
		...
		<script type="text/javascript">
				...
				function Refresh() {
					...
					window.location = '${base}/mine/diary!showSonComments.action?&diaryComment.id='+diaryCommentId;
				}
