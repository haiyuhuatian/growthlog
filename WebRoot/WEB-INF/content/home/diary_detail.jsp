		...
		<script type="text/javascript">
			 ...
			 XBack.listen(function(){
				 	...
				 	if(fromPath==""||fromPath==null){
				 		...
				 		window.location = "${base}/home/index!rankList.action";
				 	}
				});
		</script>
	</head>
		...
		<div class="content" style="margin-top:10px;">
				...
				<div class="comment" id="comment${c.id }">
					...
					<div class="comment-content">
						...
						<div style="width:100%;">
							...
							<div class="replyNum" 
								onclick="window.location='${base}/home/diary!showFamilyComments.action?diaryComment.id=${c.id}&model=${model }'">
			...
			<c:if test="${total>20 }">
				<div class="show-more-comment" 
					onclick="window.location='${base}/home/diary!moreComments.action?diary.id=${diary.id }&model=${model }'">
					点击查看更过评论
				</div>
			</c:if>
			</div>
			...
			<div class="comment-like-bar">
				...
				<c:if test="${empty(follow) }">
					<div class="follow" onclick="followUser(${diary.id})" id="follow">
							关&nbsp;&nbsp;&nbsp;注
					</div>
				</c:if>
				</c:if>
