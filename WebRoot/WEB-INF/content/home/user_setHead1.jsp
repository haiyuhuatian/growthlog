...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" href="${base }/phone-css/phone.css" type="text/css" />
		 <link rel="stylesheet" href="${base }/phone-css/cropper.min.css">
   		 <link rel="stylesheet" href="${base }/phone-css/ImgCropping.css">
...
<form method="post" action="user!saveHead.action" id="myForm">
	<input name="image" id="myImg" type="hidden"/>
</form>
...
<div onclick="test()">提交</div>
<!--图片裁剪框 end-->


<script type="text/javascript" src="${base }/js/jquery.min.js"></script>
<script type="text/javascript" src="${base }/phone-js/cropper.min.js"></script>
