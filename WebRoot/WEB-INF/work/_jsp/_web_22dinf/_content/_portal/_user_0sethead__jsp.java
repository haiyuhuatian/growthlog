...
public class _user_0sethead__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/content/portal/user_setHead.jsp"), -3117487412054490978L, false);
    _caucho_depends.add(depend);
  ...
  public void caucho_init(ServletConfig config)
  {
    try {
      ...
      _caucho_expr_7 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${type }");
      _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${!empty(headImg) }");
      _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${loginUser.id}");
      _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${headImg}");
      _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty(headImg) }");
    } catch (Exception e) {
  ...
  static {
    _jsp_string18 = "\r\n		          <img src=\"".toCharArray();
    _jsp_string23 = "/images/default_head.png\" id=\"headImg\" alt=\"Picture\">\r\n		         ".toCharArray();
    _jsp_string19 = "/uploadImages/growthLog".toCharArray();
    _jsp_string21 = "/images/default_head.png'\" id=\"headImg\" alt=\"Picture\">\r\n		         ".toCharArray();
