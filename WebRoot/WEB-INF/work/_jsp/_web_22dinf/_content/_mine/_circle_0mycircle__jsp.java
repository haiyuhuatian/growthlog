...
public class _circle_0mycircle__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/content/mine/circle_myCircle.jsp"), 7966072341565980163L, false);
    _caucho_depends.add(depend);
  ...
  public void caucho_init(ServletConfig config)
  {
    try {
      ...
      _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${loginUser.id }");
      _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${myCircles }");
      _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${c.id}");
      _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${c.create_user }");
      _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${c.cover}");
      _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${c.name }");
    } catch (Exception e) {
  ...
  static {
    _jsp_string21 = "/images/circle-cover.jpg'\" alt=\"\" />\r\n					<p style=\"width:100%;font-size:12px;height:18px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;\">".toCharArray();
    _jsp_string8 = "/mine/circle!diaryList.action?circle.id=\"+circleId;\r\n				}else if(type == 3){\r\n					window.location = \"".toCharArray();
    _jsp_string20 = "\" width=\"100%\" onerror=\"this.src='".toCharArray();
    _jsp_string24 = "/mine/circle!buildCircle.action'\">\r\n					<img src=\"".toCharArray();
    _jsp_string18 = ")\">\r\n					<img src=\"".toCharArray();
    _jsp_string10 = "', // \u5fc5\u586b\uff0c\u516c\u4f17\u53f7\u7684\u552f\u4e00\u6807\u8bc6\r\n	             timestamp: '".toCharArray();
    _jsp_string23 = "\r\n				<div style=\"width:20%;float:left;margin-left:3%;margin-top:10px;\" onclick=\"window.location='".toCharArray();
    _jsp_string26 = "/mine/circle!otherCircles.action?type=0'\">\r\n					<img src=\"".toCharArray();
    _jsp_string27 = "/images/join_circle.png\" width=\"100%\" alt=\"\" />\r\n				<span style=\"display:block;\">\u52a0\u5165\u5708\u5b50</span>\r\n				</div>\r\n				<div class=\"clear\"></div>\r\n			</div>\r\n			<div class=\"write-comment\" id=\"circleMenu\" style=\"display:none\">\r\n				<input type=\"hidden\" name=\"circle.id\" id=\"circleId\"/>\r\n				<div style=\"width:100%;margin-top:250px;\">\r\n					<div class=\"circle-menu\" onclick=\"chooseMenu(1)\">\u5708\u5b50\u8be6\u60c5</div>\r\n					<div class=\"circle-menu\" onclick=\"chooseMenu(2)\">\u8fdb\u5165\u65e5\u5fd7\u5217\u8868</div>\r\n					<div class=\"circle-menu\" onclick=\"chooseMenu(3)\">\u67e5\u770b\u6210\u5458\u5217\u8868</div>\r\n					<div class=\"circle-menu\" onclick=\"chooseMenu(4)\">\u8fd4\u56de</div>\r\n				</div>\r\n			</div>\r\n	</body>\r\n</html>\r\n".toCharArray();
    _jsp_string0 = "\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string25 = "/images/add_circle.png\" width=\"100%\" alt=\"\" />\r\n				<span style=\"display:block;\">\u521b\u5efa\u5708\u5b50</span>\r\n				</div>\r\n				<div style=\"width:20%;float:left;margin-left:3%;margin-top:10px;\" onclick=\"window.location='".toCharArray();
    _jsp_string6 = "/mine/circle!edit.action?circle.id=\"+circleId;\r\n					}else{\r\n						window.location = \"".toCharArray();
    _jsp_string9 = "/mine/circle!userList.action?init&circle.id=\"+circleId;\r\n				}else {\r\n					$(\"#circleMenu\").hide();\r\n				}\r\n			}\r\n			wx.config({\r\n				 debug: false, // \u5f00\u542f\u8c03\u8bd5\u6a21\u5f0f,\u8c03\u7528\u7684\u6240\u6709api\u7684\u8fd4\u56de\u503c\u4f1a\u5728\u5ba2\u6237\u7aefalert\u51fa\u6765\uff0c\u82e5\u8981\u67e5\u770b\u4f20\u5165\u7684\u53c2\u6570\uff0c\u53ef\u4ee5\u5728pc\u7aef\u6253\u5f00\uff0c\u53c2\u6570\u4fe1\u606f\u4f1a\u901a\u8fc7log\u6253\u51fa\uff0c\u4ec5\u5728pc\u7aef\u65f6\u624d\u4f1a\u6253\u5370\u3002\r\n	             appId: '".toCharArray();
    _jsp_string4 = "/js/jquery.js\"></script>\r\n		<script type=\"text/javascript\"  src=\"".toCharArray();
    _jsp_string22 = "</p>\r\n				</div>\r\n				".toCharArray();
    _jsp_string16 = "/images/title-bg.png\" alt=\"\" />\r\n			</div>\r\n			<div style=\"width:100%;text-align:center;\">\r\n				".toCharArray();
    _jsp_string14 = "\"/>\r\n			<input type=\"hidden\" value=\"".toCharArray();
    _jsp_string7 = "/mine/circle!detail.action?fromPath=myCircle&circle.id=\"+circleId;\r\n					}\r\n					\r\n				}else if(type == 2){\r\n					window.location = \"".toCharArray();
