...
public class HttpsUtil
{
            ...
            String outputStr)
    {
        ...
        try
        {
            ...
            // 往服务器端写内容
            /*
             * if (null != outputStr) { OutputStream os =
             * conn.getOutputStream(); os.write(outputStr.getBytes("utf-8"));
             * os.close(); }
             */
             ...
             * new InputStreamReader(is, "utf-8"); BufferedReader br = new
             * BufferedReader(isr); buffer = new StringBuffer(); String line =
